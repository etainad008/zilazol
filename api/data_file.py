...
class DataFile:
    ...
    def parse(self) -> list["Entity"]:
        ...
        entity_list_path = (f"{self.format["root"]} {self.format["entity_list"]}").split(" ")
        ...
        return [Entity(type=FILE_CATEGORY_TO_ITEM_TYPE[self.category], data=entity) for entity in entity_list]
